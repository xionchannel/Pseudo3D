...
{
  public class FaceDetector : VisionTaskApiRunner<FaceLandmarker>
  {
    ...
    private void OnFaceLandmarkDetectionOutput(FaceLandmarkerResult result, Image image, long timestamp)
    {
      ...
      _currentPosition = new Vector3(
        result.faceLandmarks[0].landmarks[1].x * 2f - 1f,
        result.faceLandmarks[0].landmarks[1].y * 2f - 1f,
